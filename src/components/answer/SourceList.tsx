      ...
      {sources.map((source) => (
        <div key={source.id} className="relative">
          ...
          {hoveredSource === source.id && (
            <div className="absolute left-0 bottom-full mb-2 w-full max-w-sm bg-white border border-border shadow-xl rounded-lg p-4 z-50 animate-in fade-in zoom-in-95 duration-200 pointer-events-none">
              <p className="text-[10px] font-bold text-brand uppercase mb-2">Preview</p>
